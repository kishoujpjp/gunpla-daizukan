...
const AI_STYLES = [
  ...
  { id: "supernatural", label: "超自然風",
    prompt: "Completely transform this image into an intensely supernatural, paranormal apparition — a cursed, otherworldly vision, NOT a photograph. You MUST heavily and dramatically repaint BOTH the subject AND its entire surroundings: nothing may remain mundane or photographic. Engulf the machine in eerie supernatural phenomena — a glowing spectral aura and ghostly translucent halo bleeding off its form, drifting wisps of ectoplasmic mist and pale blue spirit-fire, floating embers and an unsettling sense of levitation, sickly bioluminescent light leaking from every seam and joint, and luminous occult runes / glowing sigils hovering in the air around it. Re-render the environment as an uncanny, dread-soaked void: deep enveloping darkness pierced by unnatural light, swirling fog, impossibly long warped shadows, and a reality-bending distortion rippling through the atmosphere. Use a haunting otherworldly palette — spectral blues and venomous greens, abyssal black, and ominous blood-red and violet glows. The whole image must feel haunted, possessed and supernatural, radiating supernatural menace. CONSTRAINTS: keep the machine clearly recognizable and roughly in its original pose and framing, but you MAY freely and dramatically transform the lighting, background, atmosphere and add any paranormal effects to maximize the supernatural mood. Output only the image." },
