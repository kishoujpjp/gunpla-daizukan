...
const AI_STYLES = [
  ...
  { id: "surrealism", label: "超現実主義風",
    prompt: "Completely transform this image into a Surrealist dreamscape painting in the spirit of Salvador Dalí, René Magritte, Max Ernst and Yves Tanguy. Render it as a meticulously detailed, hyper-real oil painting depicting an utterly IMPOSSIBLE dream-logic scene — sharp, realistic painting technique applied to irrational, uncanny content. You MUST heavily reinvent BOTH the subject AND its world: melt, warp and elongate parts of the machine into soft, drooping, Dalí-esque forms; let pieces of it float, levitate and defy gravity; fragment it through metamorphosis and double-images so it dissolves into the landscape. Set it within a vast, eerily calm dreamscape — an endless flat desert or mirror-smooth horizon under a strange sky, with impossibly long shadows, scattered surreal objects (melting clocks, lone doors and windows opening onto other skies, floating rocks, biomorphic blobs), and a Magritte-like paradox of day and night. Use a luminous, slightly unreal palette and crisp dreamlike light. The result must feel like a vivid, irrational dream — calm yet deeply uncanny. You MAY dramatically distort, melt, multiply and recompose the machine and its surroundings, but keep it still recognizable as the original mobile suit at the heart of the dream. Output only the image." },
  { id: "dada", label: "ダダイスム風",
    prompt: "Completely reconstruct this image as a chaotic early-20th-century DADA photomontage / paper collage, in the irreverent anti-art spirit of Hannah Höch, Raoul Hausmann and Kurt Schwitters. This is NOT a clean repaint — you MUST DISMANTLE the image and rebuild it as cut-and-pasted scraps. Tear the machine apart into fragmented pieces and reassemble them at clashing angles and deliberately mismatched scales, glued over a busy collaged surface of torn vintage newspaper and magazine clippings, halftone-printed photo fragments, mechanical diagrams, gears, dismembered pointing hands, eyes and bits of unrelated bodies. Mix in nonsensical ransom-note typography — stray letters, numbers and words in many clashing fonts and sizes, set crooked and absurd. Embrace deliberate visual nonsense, jarring off-balance asymmetric composition, hand-scissored paper edges casting small shadows, aged off-white paper, visible glue marks, stains and worn analog print texture. Combine high-contrast black-and-white photo cut-outs with patches of crude flat color and bold geometric shapes. The result must look like a genuine hand-made Dada paper collage — fragmented, absurd and provocative. You MAY freely cut, rotate, rearrange and recompose everything, but keep enough of the machine recognizable amid the chaos. Output only the image." },
  ...
  { id: "cyberpunk", label: "サイバーパンク風",
    prompt: "Completely transform this image into a rain-soaked cyberpunk night scene in the visual spirit of Blade Runner. You MUST heavily repaint BOTH the subject AND its environment — nothing may remain plain or photographic. Plunge the machine into a dense neon-lit megacity at night: glowing pink, cyan and magenta neon signage with kanji/katakana hologram text, wet reflective streets, drifting fog and rain streaks, holographic advertisements, lens flares and volumetric light beams cutting through the haze. Light the machine with saturated neon rim-light and colored reflections playing across its surfaces, deep blue shadows and glowing highlights. The mood is dark, high-tech and atmospheric. Keep the machine recognizable but dramatically relit within the cyberpunk world. Output only the image." },
  { id: "vaporwave", label: "ヴェイパーウェイヴ風",
    prompt: "Completely transform this image into a 1980s/90s VAPORWAVE aesthetic composition. You MUST fully restyle BOTH the subject AND the background — nothing may remain ordinary. Drench everything in a dreamy retro palette of pastel pink, cyan and purple, with a glowing magenta sunset and a neon perspective grid receding to the horizon. Surround the machine with classic vaporwave motifs: glitch artifacts, chromatic-aberration RGB splitting, scanlines and VHS noise, a Roman marble bust or palm trees, floating geometric shapes, and stray Japanese katakana / retro computer text. Give the machine a glossy chrome or pastel-tinted finish reflecting the neon environment, washed in soft nostalgic haze. The whole image must read as surreal, nostalgic '80s digital vaporwave art. Output only the image." },
];
